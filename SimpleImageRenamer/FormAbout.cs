...
namespace SimpleImageRenamer
{
    public partial class FormAbout : Form
    {
        ...
        private void labelThirdParty_Click(object sender, EventArgs e)
        {
            Process.Start("https://github.com/exiftool/exiftool");
        }

        private void labelCopyright_Click(object sender, EventArgs e)
        {
            Process.Start("https://github.com/Nocksoft/SimpleImageRenamer");
        }
    }
}
